  ...
  >
    <v-card-text>
      <content-section
        title="자기 소개"
      >
        저는 꾸준히 폭넓게 공부하는 것을 습관화 했습니다. 또한 스터디, 교류, 동아리 또한 끊이질 않고 참여하고 있습니다.<br>
        이 꾸준한 공부와 대외 활동들은 양분이 되어 팀개발에 시너지를 낼 개발자가 탄생한다고 생각합니다. 모듈화에 능하고 테스크 관리에 능해 지속가능한 개발자면서, 유기적으로 연결된 지식을 바탕으로 누구와도 소통이 되는 개발자를 목표로 삼고 지속 성장중입니다.<br>
        ...
        이처럼 저는 같이 일하고 싶은 개발자를 최우선 목표로 다방면으로 공부하고 있으며, 현업에서도 실 적용하고 있습니다.
      </content-section>
      <content-section
        v-if="works"
        title="현업"
